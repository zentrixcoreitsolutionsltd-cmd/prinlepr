          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-3 text-xs text-slate-300">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <strong className="text-white block font-bold">Corporate Emails:</strong>
                  <div>
                    <a href="mailto:info@prinlepr.co.ke" className="hover:text-[#d89e28] underline mr-2">
                      info@prinlepr.co.ke
                    </a>
                    &bull;
                    <a href="mailto:prinleprsolutions@gmail.com" className="hover:text-[#d89e28] underline ml-2">
