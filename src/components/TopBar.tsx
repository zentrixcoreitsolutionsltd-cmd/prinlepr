  ...
  return (
    <div className="bg-[#0a1829] text-white text-[11px] sm:text-xs py-1.5 sm:py-2 px-3 sm:px-6 lg:px-12 border-b border-[#15304f]">
      <div className="w-full max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-1.5 sm:gap-2">
        {/* Contact Info: Touch-friendly links with official emails and WhatsApp */}
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-3.5 gap-y-1 text-center md:text-left">
          {/* Email 1: info@prinlepr.co.ke */}
          <a
            href="mailto:info@prinlepr.co.ke"
            className="inline-flex items-center gap-1.5 hover:text-[#d89e28] transition-colors min-h-[32px] sm:min-h-0 text-slate-300 hover:text-white"
          >
            <Mail className="w-3.5 h-3.5 text-[#d89e28] shrink-0" />
            <span>info@prinlepr.co.ke</span>
          </a>

          <span className="hidden sm:inline text-slate-600" aria-hidden="true">&bull;</span>

          {/* Email 2: prinleprsolutions@gmail.com */}
          <a
            href="mailto:prinleprsolutions@gmail.com"
            className="inline-flex items-center gap-1.5 hover:text-[#d89e28] transition-colors min-h-[32px] sm:min-h-0 text-slate-300 hover:text-white hidden lg:inline-flex"
          >
            <Mail className="w-3.5 h-3.5 text-[#d89e28] shrink-0" />
        ...
        <div className="flex items-center justify-center gap-1 sm:gap-3 shrink-0">
